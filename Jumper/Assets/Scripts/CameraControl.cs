...
public class CameraControl : MonoBehaviour 
{
	...
	void FixedUpdate () 
	{
		...
		if(introCamera)
		{
			cameraTarget.transform.position = Vector2.MoveTowards(cameraTarget.transform.position, new Vector2(player.transform.position.x, player.transform.position.y - 3.0f), 5.0f * Time.deltaTime);
